#!/usr/bin/env python3
"""Train the Galaxy10 CNN once (no notebook execution).

This script is a minimal, reproducible training entrypoint that:
- loads and preprocesses Galaxy10 data,
- performs stratified train/val/test split,
- augments selected minority classes,
- trains a CNN with class weighting + early stopping,
- saves the trained model and a compact metrics report.
"""
